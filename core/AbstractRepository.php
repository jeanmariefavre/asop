...
abstract class AbstractCachedReadOnlyModelRepository 
  ...
  public function /*List*<String!>!*/ getAllPerspectiveSoids () {
    if (! isset($this->perspectiveSoidsLoaded)) {
      $this->perspectiveSoidsLoaded = $this->loadAllPerspectiveSoids() ;
    }
    return $this->perspectiveSoidsLoaded ;
  }
...
abstract class AbstractClassModelFragment implements IClassModelFragment {
  ...
  protected /*�ClassFragment?*/ $target ;
  ...
  public function /*�ClassFragment?*/ getTarget() {
    return $this->target ;
  }
