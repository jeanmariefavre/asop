...
class MetaQueryOnlyRepository extends NativeQueryOnlyRepository
                                   implements IQueryOnlyRepository {
                                   
  const META_MODEL_FILE = "./models/meta.model.json" ;
  ...
  public function __construct(/*URL!*/ $metaRepositoryUrl, 
    ...
    parent::__construct($metaRepositoryUrl,self::META_MODEL_FILE,$logfile) ;
  }  
}
