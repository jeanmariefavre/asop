<?
  ...
  /* WARNING, table rows and columns start as 1, but the header is a sequence (starting at 0).
     TODO. Currently all the file is readed. This is ok for the header, but this could be on demand
     when accessing a particular line.
  */
class CsvFile {
